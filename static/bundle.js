...
var PeopleAdd = React.createClass({
	...
	render: function () {
		return React.createElement('div', { className: 'peopleAdd' }, React.createElement('form', { name: 'personAdd' }, React.createElement('input', { type: 'text', name: 'name', placeholder: 'Name', value: this.state.name, onChange: this.handleChangeName }), React.createElement('input', { type: 'text', name: 'photo', placeholder: 'Photo', value: this.state.img, onChange: this.handleChangePhoto }), React.createElement('input', { type: 'text', name: 'problem', placeholder: 'Problem', value: this.state.problem, onChange: this.handleChangeProblem }), React.createElement('input', { type: 'text', name: 'solution', placeholder: 'Solution', value: this.state.solution, onChange: this.handleChangeSolution }), React.createElement('button', { onClick: this.handleSubmit }, 'Add Person')));
	},
...
var PeopleList = React.createClass({
	...
	render: function () {
		return React.createElement('div', { className: 'peopleList' }, React.createElement('h1', null, 'People'), React.createElement(PeopleFilter, null), React.createElement('hr', null), React.createElement(PeopleTable, { peopledata: this.state.peopledata }), React.createElement('hr', null), React.createElement(PeopleAdd, { addperson: this.addPerson }));
	},
